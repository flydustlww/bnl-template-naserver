(function(){
    ...
    var curBillId,curPageNum,curUserType,curCount = 20,isAjaxLocked=false,isSwipe=false,isInit;
    ...
    var getPromoteInfo = function(bill_id,target){
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                insertList(tplToHtml('order-detail-tpl',{formatdata:arr},'order-info'),target);
            }
        });
    };
