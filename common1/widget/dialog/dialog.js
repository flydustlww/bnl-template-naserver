...
require('./dialog.css');(function (win, $) {
    ...
    var _bindEvent = function () {
        ...
        // hide when click on mask layer which is not in dialog
        touchEvent.tap($('body'), function (e) {
            console.log('点击由哪个元素冒泡上来的:' + e.srcElement);
            if (e.srcElement.className === 'dialog-overlay' || e.srcElement.className === 'dialog-close') {
                $.dialog.close();
            }
    ...
    var _setMaxHeight = function () {
        ...
        if ($(content).height() >= windowHeight - 10) {
            var contentTitleHeight = $(title).height() + parseInt($(title).css('margin-top'), 10) + parseInt($(title).css('margin-bottom'), 10) + parseInt($(title).css('padding-top'), 10) + parseInt($(title).css('padding-bottom'), 10);
            var contentFtHeight = $(contentFt).height() + parseInt($(contentFt).css('margin-top'), 10) + parseInt($(contentFt).css('margin-bottom'), 10) + parseInt($(contentFt).css('padding-top'), 10) + parseInt($(contentFt).css('padding-bottom'), 10);
            var contentBdSpace = parseInt($(contentBd).css('margin-top'), 10) + parseInt($(contentBd).css('margin-bottom'), 10) + parseInt($(contentBd).css('padding-top'), 10) + parseInt($(contentBd).css('padding-bottom'), 10);
    ...
    var _touchScroll = function () {
        ...
        console.log('contentBd', contentBd);
